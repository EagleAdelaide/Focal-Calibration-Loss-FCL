...
def resnet110(num_classes: int):
    # CIFAR ResNet-110: depth = 6n+2 => n=18, BasicBlock, [18,18,18]
    return CIFARResNet(BasicBlock, [18, 18, 18], num_classes=num_classes, base_width=16)
